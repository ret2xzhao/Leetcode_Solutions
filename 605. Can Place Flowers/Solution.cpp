...
int main() {
    ...
    int n1 = 1;
    std::cout<<s.canPlaceFlowers(input1, n1)<<endl;

    vector<int> input2 = {1,0,0,0,1};
    int n2 = 2;
    std::cout<<s.canPlaceFlowers(input2, n2)<<endl;

    vector<int> input3 = {0,0,0,0,1};
    int n3 = 1;
    std::cout<<s.canPlaceFlowers(input3, n3)<<endl;
}